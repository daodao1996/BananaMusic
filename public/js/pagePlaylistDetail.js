...
//      fun(currentPage);
    ...
    "getPageListModel":function(pageCount,currentPage){
       ...
       // appendStr+="<li class='"+prePageClass+"' page-data='1' page-rel='firstpage'>首页</li>";
        appendStr+="<li class='"+prePageClass+"' page1-data='"+prePage+"' page1-rel='prepage'>&laquo;</li>";
        ...
        appendStr+="<li class='"+nextPageClass+"' page1-data='"+nextPage+"' page1-rel='nextpage'>&raquo;</li>";
