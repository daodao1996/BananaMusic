...
var  page = {
    ...
    "pagelistcount":0,//每一页显示的内容条数
    "init":function(listCount,currentPage,options){
    page.type = options.type,
    page.data = options.data,
    page.pageId = options.id,
    page.maxshowpageitem = options.maxshowpageitem,//最多显示的页码个数
    page.pagelistcount = options.pagelistcount//每一页显示的内容条数
...
//      fun(currentPage);
    ...
    "getPageListModel":function(pageCount,currentPage){
       ...
       // appendStr+="<li class='"+prePageClass+"' page-data='1' page-rel='firstpage'>首页</li>";
        appendStr+="<li class='"+prePageClass+"' page-data='"+prePage+"' page-rel='prepage'>&laquo;</li>";
        ...
        appendStr+="<li class='"+nextPageClass+"' page-data='"+nextPage+"' page-rel='nextpage'>&raquo;</li>";
